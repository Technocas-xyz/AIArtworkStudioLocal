...
def get_templates():
    return {"turn1": _live_template("TEXT_TURN_1"), "turn2": _live_template("TEXT_TURN_2"),
            "turn3": _live_template("TEXT_TURN_3"), "extract": _live_template("EXTRACT_CONTACT_SHEET"),
            "regen": _live_template("EXTRACT_SINGLE"), "artwork_regen": _live_template("ARTWORK_REGENERATE"),
